    ...
    methods:{
        ...
        watchPath(to) {
            ...
            switch (to.path) {
                ...
                case "/NavDetail/ProductGoodslist": this.Path = [{ name: "商品销售", path: "" }]; break;
                case "/NavDetail/ProductServe/ProductGoodsAdd": if (to.query.detail) { this.Path = [{ name: "商品销售", path: "/NavDetail/ProductGoodslist" }, { name: "商品详情", path: "" }]; } else if(to.query.update){
                    this.Path = [{ name: "商品销售", path: "/NavDetail/ProductGoodslist" }, { name: "商品修改", path: "" }];
                    }else{this.Path = [{ name: "商品销售", path: "/NavDetail/ProductGoodslist" }, { name: "商品新增", path: "" }];}; break;
