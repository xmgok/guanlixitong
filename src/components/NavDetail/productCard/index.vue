            ...
            <div class="table_content">
                <div class="table-wrap">
                    ...
                    <el-table :data="products" ref='eTable' border style="width: 100%" align='left' @selection-change="selectDatasFun">
                        ...
                        <el-table-column prop="prodCode" label="编号" width="110">
                        </el-table-column>
                        <el-table-column prop="name" label="产品名称" fixed='left' width="200">
                        </el-table-column>
                                ...
                                <ul>
                                    ...
                                    <li v-for='(im,ix) in scope.row.jsonRules.payWay'>
                                        <span v-if='im.payWayType===0'>
                                            {{im.payWayName}}   <span v-if='im.payWayValue!=""'>,积分最高可购 ￥</span> {{im.payWayValue}}
                                        </span>
                                        <span v-if='im.payWayType!==0'>
                            ...
                            <template slot-scope="scope">
                                ...
                                <ul>
                                    ...
                                    <li v-for='(im,ix) in scope.row.jsonRules.dateLimit'>
                                        ...
                                        <span v-else>
                                           {{im.dateLimitName}}{{im.dateLimitValue}}天
                                        </span>
                                    </li>
                                </ul>
                            </template>
                        ...
                        <el-table-column label="余额扣减" width="180">
                            <template slot-scope="scope">
                                <!-- 余额扣减 -->
                                <ul>
                                     <li v-if='scope.row.jsonRules.debitWay===undefined'>每次消费后扣（按折后价）</li>
                        ...
                        <el-table-column label="过期处置" width="240">
                            <template slot-scope="scope">
                                <!-- 余额扣减 -->
                                <ul>
                                     <li v-if='scope.row.jsonRules.expireHandle===undefined'>禁止使用，剩余价值返回为可用余额</li>
                                    <li v-for='(im,ix) in scope.row.jsonRules.expireHandle'>
                                        {{im.expireHandleName}}
                                    </li>
                                </ul>
                            </template>
